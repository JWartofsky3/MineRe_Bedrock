...
function hasEnchantment(
  ...
  if (helmetSlot && helmetSlot.getItem()) {
    const itemEnchantableComponent = helmetSlot
      .getItem()
      .getComponent(ItemComponentTypes.Enchantable) as ItemEnchantableComponent;
    if (
      itemEnchantableComponent &&
