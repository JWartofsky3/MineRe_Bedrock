import { world, Vector3, BlockComponentTickEvent, BlockCustomComponent, EntityComponentTypes, EntityRidingComponent, BlockPermutation, Block, Dimension, Entity, EntityEquippableComponent, EquipmentSlot } from "@minecraft/server";
