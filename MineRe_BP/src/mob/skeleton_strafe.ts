import { Entity, EntityComponentTypes, EntityProjectileComponent, EntityTypeFamilyComponent, system } from '@minecraft/server';
...
export function skeletonStrafe(entity: Entity, chance: number) {
    ...
    const projectileComponent = entity.getComponent(EntityComponentTypes.Projectile) as EntityProjectileComponent;
    ...
    const family = owner.getComponent(EntityComponentTypes.TypeFamily) as EntityTypeFamilyComponent;
