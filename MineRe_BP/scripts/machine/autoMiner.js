...
// durable blocks
durableBlocks.set("minecraft:obsidian", 4);
durableBlocks.set("minecraft:crying_obsidian", 4);
durableBlocks.set("minecraft:ancient_debris", 3);
durableBlocks.set("minecraft:deepslate", 2);
durableBlocks.set("minecraft:cobbled_deepslate", 2);
durableBlocks.set("minecraft:deepslate_coal_ore", 2);
durableBlocks.set("minecraft:deepslate_iron_ore", 2);
durableBlocks.set("minecraft:deepslate_gold_ore", 2);
