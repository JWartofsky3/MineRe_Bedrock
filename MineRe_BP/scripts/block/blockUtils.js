...
export const oceanRuinBlocks = new Set([
  "minecraft:bricks",
...
export const shipwreckBlocks = new Set([
...
export const oceanMonumentBlocks = new Set([
  "minecraft:prismarine",
...
export const ruinedPortalBlocks = new Set([
  "minecraft:obsidian",
...
export const oceanBlocks = new Set([
  "minecraft:air",
  "minecraft:water",
  "minecraft:flowing_water",
  "minecraft:seagrass",
...
export const oceanFloorBlocks = new Set([
  "minecraft:stone",
  "minecraft:granite",
  "minecraft:diorite",
  "minecraft:andesite",
