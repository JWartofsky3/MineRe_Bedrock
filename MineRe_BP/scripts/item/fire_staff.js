import { system, world, EntityComponentTypes, ItemComponentTypes, GameMode, } from "@minecraft/server";
        ...
        system.run(() => {
            if (source.isSneaking) {
                ...
                if (source.getGameMode() !== GameMode.Creative &&
                    findItemInContainer(source.getComponent(EntityComponentTypes.Inventory)?.container, "minecraft:fire_charge") === -1) {
                    source.playSound("item.amethyst_staff.error");
                    return;
                }
