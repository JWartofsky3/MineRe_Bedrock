import { system, ItemComponentTypes, EntityComponentTypes, } from "@minecraft/server";
...
export const Illumina = {
    onUse(arg) {
        ...
        let mount = undefined;
        const ridingComponent = arg.source.getComponent(EntityComponentTypes.Riding);
        ...
        const particleRunner = system.runInterval(() => {
            for (let i = 0; i < 20; i++) {
                try {
                    dimension.spawnParticle("minecraft:end_chest", addVector3({
