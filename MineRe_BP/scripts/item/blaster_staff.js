import { system, world, EntityComponentTypes, ItemComponentTypes, EquipmentSlot, GameMode, } from "@minecraft/server";
    ...
    if (itemStack.typeId == "minere:blaster_staff") {
        system.run(() => {
            ...
            system.runTimeout(() => {
                ...
                let plasmaBolt = source.dimension.spawnEntity("minere:plasma_bolt", loc);
                ...
                plasmaBolt.applyImpulse(multiplyVector3Number(source.getViewDirection(), 7.0));
