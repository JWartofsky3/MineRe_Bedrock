...
export const windBomb = (data) => {
    ...
    system.run(() => {
        ...
        for (const entity of entities) {
            ...
            try {
                throwByPos(location, entity, baseForce * distanceScale, baseVertical * distanceScale);
                dimension.spawnParticle("minecraft:wind_charged_emitter", entity.location);
        ...
        spawnParticleCloud("minecraft:wind_explosion_emitter", location, maxRadius / 3, 5, dimension);
        system.runTimeout(() => {
            spawnParticleCloud("minecraft:wind_explosion_emitter", location, maxRadius, 25, dimension);
        }, 3);
    });
};
